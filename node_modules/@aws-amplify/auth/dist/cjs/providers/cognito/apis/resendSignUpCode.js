...
async function resendSignUpCode(input) {
    ...
    const { CodeDeliveryDetails } = await (0, CognitoIdentityProvider_1.resendConfirmationCode)({
        region: (0, utils_2.getRegion)(authConfig.userPoolId),
        userAgentValue: (0, utils_3.getAuthUserAgentValue)(utils_1.AuthAction.ResendSignUpCode),
    }, {
        Username: username,
