...
const utils_1 = require("../utils/clients/CognitoIdentityProvider/utils");
    ...
    if (tokens) {
        ...
        if (identityId && identityId.type === 'primary') {
            ...
            const logins = tokens.idToken
                ? (0, utils_2.formLoginsMap)(tokens.idToken.toString())
                : {};
...
async function generateIdentityId(logins, authConfig) {
    ...
    const region = (0, utils_1.getRegionFromIdentityPoolId)(identityPoolId);
