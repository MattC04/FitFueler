import { AuthDevice, AuthUserAttribute, AuthUserAttributeKey, AuthUserAttributes } from './models';
import { AuthServiceOptions, AuthSignUpOptions } from './options';
export interface AuthConfirmResetPasswordInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    username: string;
    newPassword: string;
 ...
 */
export interface AuthResendSignUpCodeInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    username: string;
    options?: ServiceOptions;
}
export interface AuthResetPasswordInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    username: string;
    options?: ServiceOptions;
}
export interface AuthSignInInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    username: string;
    password?: string;
    options?: ServiceOptions;
}
 ...
 */
export interface AuthSignUpInput<ServiceOptions extends AuthSignUpOptions<AuthUserAttributeKey> = AuthSignUpOptions<AuthUserAttributeKey>> {
    username: string;
    password: string;
    options?: ServiceOptions;
}
 ...
 * @param options - optional parameters for the Sign Up process, including user attributes
 */
export interface AuthConfirmSignUpInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    username: string;
    confirmationCode: string;
    options?: ServiceOptions;
}
 ...
 */
export interface AuthConfirmSignInInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
 ...
 */
export interface AuthVerifyTOTPSetupInput<ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    code: string;
    options?: ServiceOptions;
}
/**
 ...
 */
export interface AuthUpdateUserAttributesInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
 ...
 * @param options - optional parameters for the Update User Attributes process such as the service options.
 */
export interface AuthUpdateUserAttributeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    userAttribute: AuthUserAttribute<UserAttributeKey>;
    options?: ServiceOptions;
}
export interface AuthConfirmUserAttributeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey> {
 ...
 */
export interface AuthSendUserAttributeVerificationCodeInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey, ServiceOptions extends AuthServiceOptions = AuthServiceOptions> {
    userAttributeKey: UserAttributeKey;
    options?: ServiceOptions;
}
/**
 ...
 */
export interface AuthDeleteUserAttributesInput<UserAttributeKey extends AuthUserAttributeKey = AuthUserAttributeKey> {
