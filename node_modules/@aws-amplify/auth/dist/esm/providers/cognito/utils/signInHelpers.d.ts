...
import { ChallengeName, ChallengeParameters, CognitoMFAType, InitiateAuthCommandOutput, NewDeviceMetadataType, RespondToAuthChallengeCommandOutput } from './clients/CognitoIdentityProvider/types';
 ...
 */
export declare function getNewDeviceMetatada(userPoolId: string, newDeviceMetadata?: NewDeviceMetadataType, accessToken?: string): Promise<DeviceMetadata | undefined>;
/**
