import { UploadDataInput, UploadDataOutput, UploadDataWithPathInput, UploadDataWithPathOutput } from '../../types';
/**
 ...
 * ```
 */
export declare function uploadData(input: UploadDataWithPathInput): UploadDataWithPathOutput;
/**
 ...
 * ```
 */
export declare function uploadData(input: UploadDataInput): UploadDataOutput;
