...
type RestoreArrays<Result, FlatModel> = {
    [K in keyof Result]: K extends keyof FlatModel ? FlatModel[K] extends Array<any> ? Result[K] extends Array<any> ? Result[K] : Array<RestoreArrays<Result[K], UnwrapArray<FlatModel[K]>>> : FlatModel[K] extends Record<string, any> ? RestoreArrays<Result[K], FlatModel[K]> : Result[K] : never;
};
/**
...
type IndexQueryMethod<Model extends ClientSchemaByEntityTypeBaseShape['models'][string], Method extends ClientSecondaryIndexField, Context extends ContextType = 'CLIENT', FlatModel extends Record<string, unknown> = ResolvedModel<Model['type']>> = Context extends 'CLIENT' | 'COOKIES' ? <SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(input: Method['input'], options?: {
    ...
    authToken?: string;
    headers?: CustomHeaders;
}) => ListReturnValue<Prettify<ReturnValue<Model, FlatModel, SelectionSet>>> : <SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(contextSpec: AmplifyServer.ContextSpec, input: Method['input'], options?: {
    filter?: ModelFilter<Model>;
    sortDirection?: ModelSortDirection;
    limit?: number;
    nextToken?: string | null;
...
type ModelTypesSSRRequest<Model extends ClientSchemaByEntityTypeBaseShape['models'][string], FlatModel extends Record<string, unknown> = ResolvedModel<Model['type']>> = IndexQueryMethods<Model, 'REQUEST'> & {
    ...
    list<SelectionSet extends ReadonlyArray<ModelPath<FlatModel>> = never[]>(contextSpec: AmplifyServer.ContextSpec, options?: ListCpkOptions<Model> & {
        filter?: ModelFilter<Model>;
        sortDirection?: ModelSortDirection;
        limit?: number;
        nextToken?: string | null;
...
export type CustomOperations<OperationDefs extends ClientSchemaByEntityTypeBaseShape['queries' | 'mutations' | 'subscriptions'], Context extends ContextType = 'CLIENT'> = {
    [OpName in keyof OperationDefs]: {
        ...
        REQUEST: (contextSpec: AmplifyServer.ContextSpec, ...params: CustomOperationFnParams<OperationDefs[OpName]['args']>) => SingularReturnValue<OperationDefs[OpName]['type']>;
    }[Context];
};
/**
