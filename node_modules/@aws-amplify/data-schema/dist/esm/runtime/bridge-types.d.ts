...
export interface ServerClientGenerationParams {
    amplify: null | ((fn: (amplify: AmplifyClass) => Promise<any>) => Promise<any>);
...
export type GraphQLMethod = (options: GraphQLOptions, additionalHeaders?: CustomHeaders | undefined) => GraphQLResult | GraphqlSubscriptionResult;
export type GraphQLMethodSSR = (contextSpec: AmplifyServer.ContextSpec, options: GraphQLOptions, additionalHeaders?: CustomHeaders | undefined) => GraphQLResult | GraphqlSubscriptionResult;
export {};
